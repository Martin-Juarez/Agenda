...
def serch_name(self):
    ...
    file.close()
    find_name = input("Ingrese el find_name del contacto que desea consultar: ")
    contacto = file_name.get(find_name.lower())
    if contacto:
